...
declare namespace Vue {
  ...
  // options.d.ts
  export type Component<Data=DefaultData<never>, Methods=DefaultMethods<never>, Computed=DefaultComputedDef, Props=DefaultProps> = V.Component<Data, Methods, Computed, Props>;
  export type AsyncComponent<Data=DefaultData<never>, Methods=DefaultMethods<never>, Computed=DefaultComputedDef, Props=DefaultProps> = V.AsyncComponent<Data, Methods, Computed, Props>;
  export type ComponentOptions<V extends Vue, Data=DefaultData<V>, Methods=DefaultMethods<V>, Computed=DefaultComputedDef, PropsDef=PropsDefinition<DefaultProps>, Props=DefaultProps> = V.ComponentOptions<V, Data, Methods, Computed, PropsDef, Props>;
